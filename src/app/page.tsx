    ...
    <header className="sticky top-0 z-40 border-b border-border bg-background/80 backdrop-blur-md">
      <nav className="mx-auto flex h-16 max-w-6xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link
            href="/login"
            className="inline-flex min-h-11 items-center rounded-full bg-accent px-6 text-sm font-medium text-accent-foreground transition-transform hover:-translate-y-px active:translate-y-0"
          >
            Sign in
          </Link>
        </div>
    ...
    <section className="hero-glow">
      <div className="mx-auto grid max-w-6xl grid-cols-1 items-center gap-12 px-4 py-20 sm:px-6 md:grid-cols-2 md:py-32 lg:px-8">
        <div className="order-2 md:order-1">
          ...
          >
            ...
            <span className="marker-stroke relative inline-block">
              ...
              <span
                aria-hidden
                className="marker-stroke-fill absolute inset-x-0 bottom-2 -z-10 h-5"
              />
            </span>
          </h1>
        ...
        <div className="order-1 flex justify-center md:order-2">
          <Logo float interactive className="h-auto w-56 sm:w-72 lg:w-80" />
        </div>
      </div>
    </section>
  );
  ...
  return (
    <section className="bg-background pb-24">
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        <div className="scroll-reveal rounded-3xl bg-accent-deep px-6 py-16 text-center sm:px-12 sm:py-20">
          <p className="flex items-center justify-center gap-2 text-xs font-semibold uppercase tracking-[0.18em] text-accent-foreground/60">
  ...
  return (
    <footer className="relative overflow-hidden bg-accent-deep">
      ...
      <span
        aria-hidden
        lang="bn"
        className="pointer-events-none absolute -bottom-8 right-2 select-none font-bangla text-8xl font-bold text-accent-foreground/5"
      >
        পাঠশালা
      </span>
    </footer>
