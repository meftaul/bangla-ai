...
const X5B_SAY = [
  ...
  "রাস্তার ওপর ঠেলার ছায়া একটা বিন্দু, মানে 0। একটার দিকে আরেকটার কোনো ভাগই নাই।",
  ...
  return (
    <Scene scene={s} caption={T_say(X5B_SAY, k)}>
      <div className="mx-auto w-full max-w-[12.5rem]">
        <Plane f={f} grid={0} axes={false} label="ভ্যানের রাস্তা (4, 3); মামীর ঠেলা ৯০ degree কোণে, ছায়া 0; সামনে থেকে উল্টো ঠেলা, cosine −1" className="my-0! max-w-none">
          <path
