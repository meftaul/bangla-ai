...
export const COURSES: Course[] = [
  ...
  },
  {
    ...
    items: [
      ...
      "math_for_ai/09a_ferar_lens",
      "math_for_ai/09b_somer_niyom",
      "math_for_ai/09c_apar_trunk",
      "math_for_ai/09d_thikana_card",
      "math_for_ai/09e_jhapsa_lens",
      "math_for_ai/10a_bhija_khata",
      "math_for_ai/10b_moyrar_rosid",
      "math_for_ai/10c_rosid_kata",
      "math_for_ai/10d_kouta_thikana",
      "math_for_ai/10e_borhani_andha",
      "math_for_ai/10f_vanwalar_bhara",
    ],
  },
  {
